...
//     <ScrollView contentContainerStyle={styles.container}>
      ...
      {/* <Video
        ...
        style={styles.video}
        source={{
          uri: 'https://metamy.b-cdn.net/media/video/1.D%C3%B6nem/Front-End_Devolopment/Solunum_egzersizleri.mp4',
        }}
        useNativeControls
  ...
  return (
    <View style={styles.container}>
      <Video
        ...
        style={styles.video}
        source={{
          uri: 'https://romatem.b-cdn.net/Solunum_Egzersizleri/B%C3%BCz%C3%BCk%20Dudak%20Solunumu.mp4',
        }}
        useNativeControls
        // resizeMode={ResizeMode.CONTAIN}
        isLooping
